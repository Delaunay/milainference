#!/usr/bin/env python
"""
milainference documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "milainference"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import milainference.core  # noqa
...
project = "milainference"
_full_version = milainference.core.__version__
author = milainference.core.__author__
copyright = milainference.core.__copyright__
...
htmlhelp_basename = "milainference-doc"
